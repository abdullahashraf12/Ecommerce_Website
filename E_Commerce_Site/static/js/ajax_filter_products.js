...
// setInterval(function(){
    ...
    success:function(res){
        ...
        for(var i in res){
            ...
            if(res[i].Number_of_review==7 ){
                function my_func(){
                    ...
                    set_rating_stars_for_counter7='<div class="links"  style="float:left width="500px;height:200px;"><div class="wrapper" style="float:left"> <div class="popup" style="float:left; position:relative; ">     <iframe name="'+String(res[i].category_name_id)+"_"+String(res[i].child_category)+"_"+String(res[i].product_name)+'" src="star/'+String(res[i].category_name_id)+"/"+String(res[i].child_category)+"/"+String(res[i].product_name)+'" style="height:125px; width: 400px; background-color:white;" ><p hidden>Your browser does not support iframes.</p></iframe>      </div></div><form   target="iframe_id"  style="float:left" id="stars_form" action="star" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>        <button name="'+String(res[i].category_name_id)+"_"+String(res[i].child_category)+"_"+String(res[i].product_name)+'" class="btn_prog" type="submit" style="float:left; border-color:transparent; background-color:transparent;"><div style="float:"left;"><label><div class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden"  disabled></div></label><label><div  class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label><label><div   class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label><label><div  class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label><label><div   class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label><label><div   class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label><label><div   class="gold" style="float: left;"><input  type="radio"  style="visibility:hidden" disabled></div></label></div></button></form></div>'
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom" >                <form action="detail" method="GET" target="iframe_id">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>                <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].img+' style="width: 100%; height:300px; " alt="Card image cap">   </button>   </form>   </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+   set_rating_stars_for_counter7  +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"><button type="button" class="btn btn-outline-primary">Add to Cart</button></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                function my_func(){
                    ...
                    set_rating_stars_for_counter6="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
            ...
            data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>               <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].img+' style="width: 100%; height:300px; " alt="Card image cap">                    </button>                   </form>                </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency)+'</b></h6>'+   set_rating_stars_for_counter6 +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"><button type="button" class="btn btn-outline-primary">Add to Cart</button></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                function my_func(){
                    ...
                    set_rating_stars_for_counter5="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
                ...
                function my_func(){
                    ...
                    setTimeout(clear_my_func,4000)
                    set_rating_stars_for_counter4="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
            ...
            data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom">             <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>            <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">            <img class="card-img-top" src=/media/'+res[i].img+' style="width: 100%; height:300px; " alt="Card image cap">                </button>                </form>                   </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter4      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"><button type="button" class="btn btn-outline-primary">Add to Cart</button></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                function my_func(){
                    ...
                    set_rating_stars_for_counter3="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
                ...
                function my_func(){
                    ...
                    set_rating_stars_for_counter2="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
                ...
                function my_func(){
                    ...
                    setTimeout(clear_my_func,4000)
                    set_rating_stars_for_counter1="<div style='float:'left;'>   <label><div  class='gold' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label></div>"
                ...
                function my_func(){
                    ...
                    setTimeout(clear_my_func,4000)
                    set_rating_stars_for_counter0="<div style='float:'left;'>   <label><div  class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div  class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div  class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden'  disabled></div></label><label><div   class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label><label><div   class='silver' style='float: left;'><input  type='radio'  style='visibility:hidden' disabled></div></label></div>"
        ...
        arr.push({
            ...
            value:'iframe[name="'+btn[i].name.toString()+'"]'
        })
    }
    for (const [key, value] of Object.entries(arr)) {
        ...
        $(arr[key].key).mouseenter(function (d) {
            ...
            data.append('view_product_category', 'person');
            data.append('view_child_category', 'password');
            data.append('view_product_name', 'place');
