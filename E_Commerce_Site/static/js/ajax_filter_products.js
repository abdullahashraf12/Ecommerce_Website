...
// setInterval(function(){
    ...
    success:function(res){
        ...
        for(var i in res){
            ...
            data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>               <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                    </button>                   </form>                </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency)+'</b></h6>'+   set_rating_stars_for_counter6 +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom"> <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>   <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; "> <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">    </button>                    </form>                    </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+    set_rating_stars_for_counter5  +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
            ...
            data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom">             <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>            <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">            <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                </button>                </form>                   </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter4      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom" >                <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>                <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                    </button>                    </form>                        </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter3      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"</div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom">                <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>                <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">              <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                  </button>                    </form>                       </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter2      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom"> <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>                <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                    </button>                    </form> </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter1      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
                ...
                data+='<div class="card-group" style="float: left;"><div class="card" style="width: 400px; height: 150;" ><div style="width: 100%; height: min-content;  " class="zoom">                <form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/>                <button type="submit" style="border: transparent;; width: 100%; height:300px; border-color: transparent; background: transparent; background-color:transparent ; ">                <img class="card-img-top" src=/media/'+res[i].main_img+' style="width: 100%; height:300px; " alt="Card image cap">                    </button>                    </form>                    </div><div class="card-body" style="height:75px;"><h5 class="card-title">'+ String(res[i].product_name) + '</h5><h6 class="card-title" style="float:left"> <b>Price</b> <b style="color: yellowgreen;">' + String(res[i].price)+ '  '+ String(res[i].currency) +'</b></h6>'+     set_rating_stars_for_counter0      +'</div> <div class="card-body">'+String(res[i].brief_description) +'</div><div class="card-body"><div style="border: 1px; "><div style="display: inline-block;"></div><div style="display: inline-block; border: 1px"><form action="detail" method="POST">  <input name="csrfmiddlewaretoken" value="'+  String(text)   +'" hidden><input type="hidden" value="'+String(res[i].product_name) +'" name="view_product_name" /><input type="hidden" value="'+String(res[i].category_name_id)+'" name="view_product_category"/><input type="hidden" value="'+String(res[i].child_category)+'" name="view_child_category"/><button type="submit" class="btn btn-outline-warning" style="width: 350px;">View Product</button></form></div></div></div><div class="card-footer"><small class="text-muted">Added on "'+String(res[i].time_Added)+'</small></div></div></div><div style="width: 5px;"></div>'
